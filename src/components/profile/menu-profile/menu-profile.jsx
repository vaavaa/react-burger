        ...
        <div className={style.profile_cont}>
            <ul className={`${style.profile_menu} mr-15`}>
                <li className={`${style.profile_menu_item} text text_type_main-medium text_color_inactive`}>
                    <NavLink to={`/user-profile`} className={style.link} activeClassName={"text_color_primary"}>Профиль</NavLink>
                </li>
                <li className={`${style.profile_menu_item} text text_type_main-medium text_color_inactive`}>
                    <NavLink to={`/profile/orders`} className={style.link} activeClassName={"text_color_primary"}>История заказов</NavLink>
                </li>
                <li onClick={handleClick}
                    className={`${style.profile_menu_item} text text_type_main-medium text_color_inactive`}>
                    <NavLink exact={true} to={`/login`} className={style.link} activeClassName={"text_color_primary"}>Выход</NavLink>
                </li>
            </ul>
